...
const exploreRepos = [
  {
    ...
    language: 'TypeScript',
    description: 'A JavaScript chess library for chess move generation, validation, and engine communication',
    stars: '4.1k',
  },
  {
  ...
  },
  {
    ...
    language: 'TypeScript',
    description: 'A JavaScript/TypeScript game engine for making 2D games with HTML5 and WebGL',
    stars: '2.1k',
  },
];
        ...
        {exploreRepos.map((repo, index) => (
          <li
            ...
            className={`rounded p-3 flex flex-col gap-y-3 ${
              index === exploreRepos.length - 1 ? '' : 'border-b border-white/10'
            }`}
          >
            <RepoCard
              name={repo.name}
